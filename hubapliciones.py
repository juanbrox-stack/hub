...
apps = [
    ...
    {"nombre": "Características PS 2026", "url": "https://caracteristicaspsturaco2026.streamlit.app/", "icon": "featuresps.svg", "desc": "Gestión avanzada de características PrestaShop 2026.", "color": "#FAF9F5", "cat": "Catálogo", "pdf": "Características 2026.pdf"},
    {"nombre": "Cecotec Descarga Feed Países", "url": "https://cecotec-downloader.streamlit.app", "icon": "cecotec-downloader.svg", "desc": "Descarga de catálogos y datos de la web de Cecotec.", "color": "#FAF9F5", "cat": "Scraping", "pdf": "Cecotec Downloader.pdf"},
    ...
    {"nombre": "Errores Mirakl", "url": "https://errors.streamlit.app/", "icon": "marketplaces.svg", "desc": "Analizar errores de publicación Mirakl / Marketplaces.", "color": "#FAF9F5", "cat": "Errores", "pdf": "Errors.pdf"},
    {"nombre": "Concatenar URLs PIM para PrestaShop", "url": "https://concatenarurl.streamlit.app/", "icon": "marketplaces.svg", "desc": "Generador de URLs absolutas para imágenes de productos.", "color": "#FAF9F5", "cat": "Catálogo", "pdf": "Extractor de URLs para PrestaShop.pdf"},
    {"nombre": "Crea ficheros de características para Herramientas", "url": "https://featuresps.streamlit.app", "icon": "featuresps.svg", "desc": "Creación de fichero del fichero de características para herramientas.", "color": "#FAF9F5", "cat": "Catálogo", "pdf": "Features PS.pdf"},
    {"nombre": "Generador de fichero para actualizar tarifas en Amazon", "url": "https://generarplantillatarifasamazon.streamlit.app/", "icon": "stockamazon.svg", "desc": "Generación de plantillas de tarifas personalizadas para Amazon.", "color": "#FAF9F5", "cat": "Tarifas", "pdf": "Manual_Generador_Tarifas_Amazon.pdf"},
    {"nombre": "Informe Ventas Marketing", "url": "https://automatizacionventasmkt.streamlit.app/", "icon": "marketplaces.svg", "desc": "Análisis estratégico y automatización de informes para el departamento de Marketing.", "color": "#FAF9F5", "cat": "Marketing", "pdf": "Manual_Usuario_Informe_Ventas_MKT.pdf"},
    ...
    {"nombre": "Mapear Categorías PS vs Amazon", "url": "https://mapcategories.streamlit.app", "icon": "mapcategories.svg", "desc": "Mapeo lógico de categorías Amazon vs PrestaShop.", "color": "#FAF9F5", "cat": "Logística", "pdf": "Map Categories.pdf"},
    {"nombre": "Analiza ventas por Marketplaces", "url": "https://multitienda-bi-group.streamlit.app", "icon": "marketplaces.svg", "desc": "BI de pedidos, análisis por marketplaces y año.", "color": "#FAF9F5", "cat": "BI", "pdf": "Marketplaces.pdf"},
    {"nombre": "Explorador de categorías y campos requeridos Mediamarkt", "url": "https://atributosmediamarkt.streamlit.app/", "icon": "marketplaces.svg", "desc": "Explorador de categorías y atributos específicos para MediaMarkt.", "color": "#FAF9F5", "cat": "Catálogo", "pdf": "Manual_MM_Category_Explorer.pdf"},
    {"nombre": "Descarga masiva Banco de Imágenes y PIM", "url": "https://descargaspim.streamlit.app/", "icon": "marketplaces.svg", "desc": "Descarga masiva de activos y datos desde el PIM Plytix.", "color": "#FAF9F5", "cat": "Scraping", "pdf": "manual_plytix_downloader.pdf"},
    {"nombre": "Creación de Novedades PrestaShop - PS Bridge", "url": "https://ps-bridge.streamlit.app", "icon": "ps-bridge.svg", "desc": "Fichero de subida de novedades a PrestaShop.", "color": "#FAF9F5", "cat": "Catálogo", "pdf": "PS Bridge.pdf"},
    {"nombre": "Recortador Títulos y Descripciones", "url": "https://recortadorcadenastexto.streamlit.app/", "icon": "marketplaces.svg", "desc": "Limpieza y recorte de longitud de textos.", "color": "#FAF9F5", "cat": "Utilidad", "pdf": "Recortador Cadenas.pdf"},
    ...
    {"nombre": "Revisar URLs Fotos", "url": "https://revisarurlimagenes.streamlit.app/", "icon": "marketplaces.svg", "desc": "Validación masiva de URLs de imágenes (Evita 404).", "color": "#FAF9F5", "cat": "Calidad", "pdf": "Revisar URL Fotos.pdf"},
...
# --- ÍNDICE RÁPIDO ---
# Combinamos ambas listas para que el índice rápido tenga constancia de absolutamente todas las apps
...
# Si se busca una app del flujo, incluirla en la parrilla general de resultados
