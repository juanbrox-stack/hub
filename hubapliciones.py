...
apps = [
    ...
    {"nombre": "SKUs Faltantes Amazon Turaco vs Jabiru", "url": "https://skusfaltantesamazon.streamlit.app/", "icon": "stockamazon.svg", "desc": "Auditoría y comparativa de productos creados para la detección de SKUs faltantes en países Jabiru vs Turaco Amazon.", "color": "#FAF9F5", "cat": "Auditoría", "pdf": "ManualCompartivaProductosCreadosAmazonJabiruTuraco.pdf"},
