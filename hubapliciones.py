...
# He añadido la clave "pdf" a cada una con el nombre del archivo correspondiente
apps = [
    ...
    {"nombre": "50 Top Ventas ES", "url": "https://50topventases.streamlit.app", "icon": "50topventases.svg", "desc": "Creación del fichero para enviar el top ventas semanal de productos líderes.", "color": "#f1f8e9", "cat": "Reporting", "pdf": "top_ventas.pdf"},
...
# --- SECCIÓN: EXPLICACIÓN ---
st.markdown("""
<div style="background-color: #f8f9fa; padding: 20px; border-radius: 15px; border-left: 5px solid #007bff; margin-bottom: 20px;">
    <h4>📖 Centro de Operaciones y Estructuras</h4>
    <p style="font-size: 0.9rem;">Cada aplicación requiere una estructura de columnas específica. 
    Usa el enlace <b>📂 Estructura PDF</b> de cada tarjeta para ver el manual técnico antes de procesar tus archivos.</p>
</div>
""", unsafe_allow_html=True)
