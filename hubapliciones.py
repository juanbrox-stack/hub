...
apps = [
    ...
    {"nombre": "Comparador de competencia", "url": "https://comparadorbestseller.streamlit.app/", "icon": "marketplaces.svg", "desc": "Herramienta avanzada de comparación y auditoría para productos Bestseller.", "color": "#FAF9F5", "cat": "Auditoría", "pdf": "Manual_Usuario_Comparador_Bestseller_v3.pdf"},
